...
- (void)viewDidLoad
{
    ...
    [FlatTheme styleNavigationBar:self.navigationController.navigationBar withFontName:self.boldFontName andColor:[UIColor colorWithRed:65.0/255 green:75.0/255 blue:89.0/255 alpha:1.0]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if([element isEqualToString:@"Switch"]){
        ...
        UISegmentedControl* control = [self createSegmentedControlWithItems:[NSArray arrayWithObjects:@"YES", @"NO", @"ALL", nil]];
